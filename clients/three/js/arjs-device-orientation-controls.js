...
const ArjsDeviceOrientationControls = function ( object, alphaOffset=90, smoothingFactor=0.1 ) {
  ...
  this.alphaOffset = alphaOffset * (Math.PI / 180.0); 
...
export { ArjsDeviceOrientationControls };
