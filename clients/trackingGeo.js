...
IrAndGeo.initIr = function() {
    ...
    this.targetCollectionResource = new AR.TargetCollectionResource("./src/assets/ShopAd.wtc", {
        onLoaded: function() {
...
IrAndGeo.res.marker = new AR.ImageResource("./src/assets/YourShop_Marker.png", {
    onLoaded: IrAndGeo.loadingStepDone,
    onError: IrAndGeo.errorLoading
});
IrAndGeo.res.buttonWeb = new AR.ImageResource("./src/assets/YourShop_OpenWebsite.png", {
    onLoaded: IrAndGeo.loadingStepDone,
    onError: IrAndGeo.errorLoading
});
IrAndGeo.res.buttonStores = new AR.ImageResource("./src/assets/YourShop_FindShops.png", {
    onLoaded: IrAndGeo.loadingStepDone,
    onError: IrAndGeo.errorLoading
});
IrAndGeo.res.buttonDeal = new AR.ImageResource("./src/assets/YourShop_GetADeal.png", {
    onLoaded: IrAndGeo.loadingStepDone,
    onError: IrAndGeo.errorLoading
});
IrAndGeo.res.deal = new AR.ImageResource("./src/assets/YourShop_Deal.png", {
    onLoaded: IrAndGeo.loadingStepDone,
    onError: IrAndGeo.errorLoading
});
